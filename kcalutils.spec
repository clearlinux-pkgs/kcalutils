...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kcalutils-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kcalutils-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kcalutils-23.08.2
cd %{_builddir}/kcalutils-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697405019
mkdir -p clr-build
pushd clr-build
