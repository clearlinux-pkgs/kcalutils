...
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/kcalutils-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/kcalutils-23.04.0.tar.xz.sig
...
%prep
%setup -q -n kcalutils-23.04.0
cd %{_builddir}/kcalutils-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682098268
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim5CalendarUtils.so.5.23.0
