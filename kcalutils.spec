...
Version  : 24.08.1
Release  : 77
URL      : https://download.kde.org/stable/release-service/24.08.1/src/kcalutils-24.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kcalutils-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kcalutils-24.08.1.tar.xz.sig
...
%setup -q -n kcalutils-24.08.1
cd %{_builddir}/kcalutils-24.08.1
pushd ..
cp -a kcalutils-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726500220
mkdir -p clr-build
pushd clr-build
