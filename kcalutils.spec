...
Version  : 19.12.1
Release  : 19
URL      : https://download.kde.org/stable/release-service/19.12.1/src/kcalutils-19.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/kcalutils-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/kcalutils-19.12.1.tar.xz.sig
...
%prep
%setup -q -n kcalutils-19.12.1
cd %{_builddir}/kcalutils-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578931004
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcalutils-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/kcalutils/52587f1695c0aa1f770f3a445033b920a66d3566
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5CalendarUtils.so.5.13.1
