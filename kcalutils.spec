...
Version  : 19.12.2
Release  : 20
URL      : https://download.kde.org/stable/release-service/19.12.2/src/kcalutils-19.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/kcalutils-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/kcalutils-19.12.2.tar.xz.sig
...
%prep
%setup -q -n kcalutils-19.12.2
cd %{_builddir}/kcalutils-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581087331
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcalutils-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/kcalutils/52587f1695c0aa1f770f3a445033b920a66d3566
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5CalendarUtils.so.5.13.2
