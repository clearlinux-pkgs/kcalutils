...
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/kcalutils-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/kcalutils-23.04.2.tar.xz.sig
...
%prep
%setup -q -n kcalutils-23.04.2
cd %{_builddir}/kcalutils-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686543711
mkdir -p clr-build
pushd clr-build
