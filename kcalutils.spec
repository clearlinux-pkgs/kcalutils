...
Version  : 25.04.1
Release  : 85
URL      : https://download.kde.org/stable/release-service/25.04.1/src/kcalutils-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/kcalutils-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/kcalutils-25.04.1.tar.xz.sig
...
%setup -q -n kcalutils-25.04.1
cd %{_builddir}/kcalutils-25.04.1
pushd ..
cp -a kcalutils-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747180883
mkdir -p clr-build
pushd clr-build
