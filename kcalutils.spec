...
Version  : 19.04.0
Release  : 8
URL      : https://download.kde.org/stable/applications/19.04.0/src/kcalutils-19.04.0.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.0/src/kcalutils-19.04.0.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.0/src/kcalutils-19.04.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1555644884
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5CalendarUtils.so.5.11.0
