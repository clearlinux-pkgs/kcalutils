...
Version  : 19.04.2
Release  : 11
URL      : https://download.kde.org/stable/applications/19.04.2/src/kcalutils-19.04.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.2/src/kcalutils-19.04.2.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.2/src/kcalutils-19.04.2.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1559914732
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKF5CalendarUtils.so.5.11.2
