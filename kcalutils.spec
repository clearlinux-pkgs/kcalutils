...
Version  : 22.08.0
Release  : 46
URL      : https://download.kde.org/stable/release-service/22.08.0/src/kcalutils-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kcalutils-22.08.0.tar.xz
...
%prep
%setup -q -n kcalutils-22.08.0
cd %{_builddir}/kcalutils-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661563958
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5CalendarUtils.so.5.21.0
