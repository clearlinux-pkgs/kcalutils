...
Version  : 23.08.3
Release  : 63
URL      : https://download.kde.org/stable/release-service/23.08.3/src/kcalutils-23.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/kcalutils-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/kcalutils-23.08.3.tar.xz.sig
...
%prep
%setup -q -n kcalutils-23.08.3
cd %{_builddir}/kcalutils-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699584925
mkdir -p clr-build
pushd clr-build
