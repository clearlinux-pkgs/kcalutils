...
Version  : 23.08.4
Release  : 65
URL      : https://download.kde.org/stable/release-service/23.08.4/src/kcalutils-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/kcalutils-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/kcalutils-23.08.4.tar.xz.sig
...
%prep
%setup -q -n kcalutils-23.08.4
cd %{_builddir}/kcalutils-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702995267
mkdir -p clr-build
pushd clr-build
